(() => {
  ...
  ensureStyle('link[data-tns-type-progress-style="true"]', "./tns-type-detection-progress.css?v=20260828-ndless-workspace-v4", "tnsTypeProgressStyle");
  ensureStyle('link[data-ndless-tns-inspector-style="true"]', "./ndless-tns-inspector.css?v=20260828-ndless-workspace-v4", "ndlessTnsInspectorStyle");
  ensureStyle('link[data-ndless-editor-style="true"]', "./ndless-editor.css?v=20260828-ndless-workspace-v4", "ndlessEditorStyle");
  ...
  const ndlessChain = loadScript('script[data-ndless-zehn="true"]', "./ndless-zehn.js?v=20260828-ndless-workspace-v4", "ndlessZehn")
    .then(() => loadScript('script[data-ndless-bflt="true"]', "./ndless-bflt.js?v=20260828-ndless-workspace-v4", "ndlessBflt"))
    .then(() => loadScript('script[data-ndless-prg="true"]', "./ndless-prg.js?v=20260828-ndless-workspace-v4", "ndlessPrg"))
    .then(() => loadScript('script[data-ndless-format-detector="true"]', "./ndless-format-detector.js?v=20260828-ndless-workspace-v4", "ndlessFormatDetector"))
    .then(() => loadScript('script[data-tns-type-progress="true"]', "./tns-type-detection-progress.js?v=20260828-ndless-workspace-v4", "tnsTypeProgress"))
    .then(() => loadScript('script[data-ndless-tns-inspector="true"]', "./ndless-tns-inspector.js?v=20260828-ndless-workspace-v4", "ndlessTnsInspector"))
    .then(() => loadScript('script[data-ndless-arm-decoder="true"]', "./ndless-arm-decoder.js?v=20260828-ndless-workspace-v4", "ndlessArmDecoder"))
    .then(() => loadScript('script[data-ndless-analysis="true"]', "./ndless-analysis.js?v=20260828-ndless-workspace-v4", "ndlessAnalysis"))
    .then(() => loadScript('script[data-ndless-rebuilder="true"]', "./ndless-rebuilder.js?v=20260828-ndless-workspace-v4", "ndlessRebuilder"))
    .then(() => loadScript('script[data-ndless-editor="true"]', "./ndless-editor.js?v=20260828-ndless-workspace-v4", "ndlessEditor"));

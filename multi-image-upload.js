(() => {
  ...
  const NOTES_SAVE_FIX_V="20260904-notepad-save-fix-v1";
  ...
  ensureStyle('link[data-ndless-build-ui-style="true"]', `./ndless-build-ui.css?v=${V}`, "ndlessBuildUiStyle");
  ...
  const tnsChain = loadScript('script[data-tns-container-registry="true"]', `./tns-container-registry.js?v=${V}`, "tnsContainerRegistry")
    ...
    .then(() => loadScript('script[data-ndless-elf32="true"]', `./ndless-elf32.js?v=${V}`, "ndlessElf32"))
    .then(() => loadScript('script[data-ndless-zehn-builder="true"]', `./ndless-zehn-builder.js?v=${V}`, "ndlessZehnBuilder"))
    ...
    .then(() => loadScript('script[data-ndless-arm-runtime-v2="true"]', `./ndless-arm-runtime-v2.js?v=${V}`, "ndlessArmRuntimeV2"))
    ...
    .then(() => loadScript('script[data-ndless-browser-compiler="true"]', `./ndless-browser-compiler.js?v=${V}`, "ndlessBrowserCompiler"))
    .then(() => loadScript('script[data-ndless-browser-live-preview="true"]', `./ndless-browser-live-preview.js?v=${V}`, "ndlessBrowserLivePreview"))
  ...
  const independent = [
    ...
    ['script[data-notepad-rich-save-fix="true"]', `./notepad-rich-save-fix.js?v=${NOTES_SAVE_FIX_V}`, "notepadRichSaveFix"],

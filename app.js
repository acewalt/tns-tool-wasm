...
function showLuaPageEditor(editor) {
  ...
  backdrop.querySelector("#lua-page-apply").addEventListener("click", () => {
    ...
    const newBlock = updateLuaPageBlock(page.block, { name: nameInput.value, items, targets });
...
function showLuaEditor(item) {
  ...
  backdrop.innerHTML = `
    <div class="modal lua-modal">
      <div class="lua-toolbar">
        ...
        <button type="button" id="lua-page-editor" class="green-tool-button">${escapeHtml(t("luaEditPages"))}</button>
  ...
  backdrop.querySelector("#lua-page-editor").addEventListener("click", () => showLuaPageEditor(editor));

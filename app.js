...
const SOURCE_VERSION = "2026-08-25-calculator-love-exact-templates-v8";
...
function calculatorLoveTemplatePaletteLua(){
  return `
local fontTiny = love.graphics.newFont(10)
local fontSmall = love.graphics.newFont(12)
local fontNormal = love.graphics.newFont(16)
local fontBig = love.graphics.newFont(24)

local function box(x,y,w,h) love.graphics.rectangle("line",x,y,w,h) end
local function smallBox(x,y) box(x,y,10,10) end
local function normalBox(x,y) box(x,y,16,18) end
local function leftBracket(x,y,h)
  love.graphics.line(x+6,y,x,y)
  love.graphics.line(x,y,x,y+h)
  love.graphics.line(x,y+h,x+6,y+h)
end
...
local function brace(x,y,h)
  local m=y+h/2
  love.graphics.line(x+9,y,x+4,y)
  love.graphics.line(x+4,y,x+2,y+6)
  love.graphics.line(x+2,y+6,x+2,m-5)
  love.graphics.line(x+2,m-5,x-2,m)
  love.graphics.line(x-2,m,x+2,m+5)
  love.graphics.line(x+2,m+5,x+2,y+h-6)
  love.graphics.line(x+2,y+h-6,x+4,y+h)
  love.graphics.line(x+4,y+h,x+9,y+h)
end
...
local function sigma(x,y,w,h)
  love.graphics.line(x+w,y,x,y)
  love.graphics.line(x,y,x+w*.60,y+h/2)
  love.graphics.line(x+w*.60,y+h/2,x,y+h)
  love.graphics.line(x,y+h,x+w,y+h)
end
local function productSymbol(x,y,w,h)
  love.graphics.line(x,y,x+w,y)
  love.graphics.line(x+3,y,x+3,y+h)
  love.graphics.line(x+w-3,y,x+w-3,y+h)
end
local function matrix(x,y,rows,cols)
  local cw,ch=20,22
  local w,h=cols*cw,rows*ch
  leftBracket(x,y,h);rightBracket(x+w+10,y,h)
  for r=1,rows do
    for c=1,cols do smallBox(x+8+(c-1)*cw,y+6+(r-1)*ch) end
  end
end

local function iconFraction(x,y) normalBox(x+30,y);love.graphics.line(x+24,y+25,x+54,y+25);normalBox(x+30,y+31) end
local function iconExponent(x,y) normalBox(x+24,y+23);smallBox(x+42,y+12) end
local function iconSqrt(x,y) radical(x+15,y+17,58,34);normalBox(x+43,y+25) end
local function iconNthRoot(x,y) smallBox(x+11,y+12);radical(x+20,y+17,58,34);normalBox(x+49,y+25) end
local function iconExpE(x,y) love.graphics.setFont(fontBig);love.graphics.print("e",x+23,y+19);smallBox(x+42,y+10) end
local function iconLogBase(x,y) love.graphics.setFont(fontNormal);love.graphics.print("log",x+9,y+20);smallBox(x+33,y+37);normalBox(x+48,y+20) end
local function iconPiecewise2(x,y) brace(x+15,y+13,50);normalBox(x+29,y+15);normalBox(x+55,y+15);normalBox(x+29,y+42);normalBox(x+55,y+42);love.graphics.setFont(fontSmall);love.graphics.print(",",x+48,y+18);love.graphics.print(",",x+48,y+45) end
local function iconPiecewiseN(x,y) brace(x+15,y+7,67);normalBox(x+29,y+8);normalBox(x+56,y+8);normalBox(x+29,y+31);normalBox(x+56,y+31);love.graphics.setFont(fontNormal);love.graphics.print("...",x+31,y+48);normalBox(x+56,y+54) end
local function iconSystem2(x,y) brace(x+18,y+14,49);normalBox(x+33,y+15);normalBox(x+33,y+43) end
local function iconSystemN(x,y) brace(x+18,y+6,68);normalBox(x+33,y+7);normalBox(x+33,y+29);love.graphics.setFont(fontSmall);love.graphics.print("...",x+35,y+47);normalBox(x+33,y+58) end
local function iconAbsolute(x,y) love.graphics.line(x+20,y+17,x+20,y+56);normalBox(x+32,y+27);love.graphics.line(x+61,y+17,x+61,y+56) end
local function iconDMS(x,y) normalBox(x+5,y+27);love.graphics.setFont(fontNormal);love.graphics.print("o",x+21,y+13);normalBox(x+34,y+27);love.graphics.setFont(fontBig);love.graphics.print("'",x+51,y+13);normalBox(x+60,y+27);love.graphics.print("''",x+76,y+13) end
local function iconMatrix22(x,y) matrix(x+17,y+13,2,2) end
local function iconMatrix12(x,y) matrix(x+17,y+26,1,2) end
local function iconMatrix21(x,y) matrix(x+29,y+13,2,1) end
local function iconMatrixMN(x,y) matrix(x+9,y+7,3,3) end
local function iconSum(x,y) smallBox(x+31,y+4);sigma(x+24,y+20,31,35);smallBox(x+13,y+59);love.graphics.setFont(fontSmall);love.graphics.print("=",x+25,y+58);smallBox(x+36,y+59);normalBox(x+61,y+29) end
local function iconProduct(x,y) smallBox(x+31,y+4);productSymbol(x+25,y+20,31,35);smallBox(x+13,y+59);love.graphics.setFont(fontSmall);love.graphics.print("=",x+25,y+58);smallBox(x+36,y+59);normalBox(x+62,y+29) end
local function iconDerivative1(x,y) love.graphics.setFont(fontSmall);love.graphics.print("d",x+22,y+11);love.graphics.line(x+17,y+31,x+39,y+31);love.graphics.print("d",x+17,y+37);smallBox(x+29,y+39);normalBox(x+49,y+24) end
local function iconDerivative2(x,y) love.graphics.setFont(fontSmall);love.graphics.print("d",x+20,y+10);love.graphics.setFont(fontTiny);love.graphics.print("2",x+30,y+5);love.graphics.line(x+16,y+31,x+43,y+31);love.graphics.setFont(fontSmall);love.graphics.print("d",x+16,y+38);smallBox(x+29,y+40);love.graphics.setFont(fontTiny);love.graphics.print("2",x+40,y+34);normalBox(x+53,y+24) end
local function iconDerivativeN(x,y) love.graphics.setFont(fontSmall);love.graphics.print("d",x+17,y+10);smallBox(x+29,y+3);love.graphics.line(x+14,y+32,x+47,y+32);love.graphics.print("d",x+14,y+39);smallBox(x+27,y+41);smallBox(x+39,y+34);normalBox(x+57,y+24) end
local function iconIntegralDef(x,y) smallBox(x+20,y+5);smallBox(x+8,y+61);integralSymbol(x+28,y+12,50);normalBox(x+47,y+28);love.graphics.setFont(fontSmall);love.graphics.print("d",x+68,y+32);smallBox(x+78,y+35) end
local function iconIntegralIndef(x,y) integralSymbol(x+23,y+12,52);normalBox(x+41,y+29);love.graphics.setFont(fontSmall);love.graphics.print("d",x+62,y+33);smallBox(x+73,y+36) end
local function iconLimit(x,y) love.graphics.setFont(fontNormal);love.graphics.print("lim",x+7,y+17);smallBox(x+12,y+44);love.graphics.setFont(fontSmall);love.graphics.print("→",x+24,y+43);smallBox(x+43,y+44);normalBox(x+64,y+20) end
local function iconIndicator(x,y) box(x+27,y+23,16,16);love.graphics.rectangle("fill",x+48,y+34,11,11) end

local icons={
  {"01 Fracción",iconFraction},{"02 Exponente",iconExponent},{"03 Raíz cuadrada",iconSqrt},{"04 Raíz enésima",iconNthRoot},{"05 Exponencial e",iconExpE},
  {"06 Logaritmo base",iconLogBase},{"07 Por partes 2",iconPiecewise2},{"08 Por partes n",iconPiecewiseN},{"09 Sistema 2",iconSystem2},{"10 Sistema n",iconSystemN},
  {"11 Valor absoluto",iconAbsolute},{"12 Grados min seg",iconDMS},{"13 Matriz 2x2",iconMatrix22},{"14 Matriz 1x2",iconMatrix12},{"15 Matriz 2x1",iconMatrix21},
  {"16 Matriz m x n",iconMatrixMN},{"17 Sumatoria",iconSum},{"18 Productoria",iconProduct},{"19 Derivada 1",iconDerivative1},{"20 Derivada 2",iconDerivative2},
  {"21 Derivada n",iconDerivativeN},{"22 Integral definida",iconIntegralDef},{"23 Integral indef.",iconIntegralIndef},{"24 Límite",iconLimit},{"25 Indicador",iconIndicator}
}
function love.load() love.graphics.setBackgroundColor(.965,.965,.965);love.graphics.setLineWidth(2.5) end
function love.draw()
  love.graphics.clear(.965,.965,.965,1)
  local W,H=love.graphics.getDimensions()
  local cols,rows=5,5
  local mx,my,gap,top=8,8,6,25
  local cw=(W-mx*2-gap*(cols-1))/cols
  local ch=(H-top-my-gap*(rows-1))/rows
  love.graphics.setColor(.08,.08,.08,1);love.graphics.setFont(fontNormal);love.graphics.print("Plantillas matemáticas",10,5)
  for i,item in ipairs(icons) do
    local n=i-1; local r=math.floor(n/cols); local c=n%cols
    local x=mx+c*(cw+gap);local y=top+r*(ch+gap)
    love.graphics.setColor(.80,.80,.80,1);love.graphics.setLineWidth(1.5);love.graphics.rectangle("line",x,y,cw,ch)
    love.graphics.setColor(.08,.08,.08,1);love.graphics.setLineWidth(2.5)
    love.graphics.push()
    local scale=math.min((cw-12)/90,(ch-24)/80)
    local centerX=x+cw*.5;local centerY=y+ch*.42
    love.graphics.translate(centerX,centerY);love.graphics.scale(scale,scale);item[2](-45,-38);love.graphics.pop()
    love.graphics.setFont(fontTiny);love.graphics.setColor(.15,.15,.15,1);love.graphics.print(item[1],x+5,y+ch-15)
  end
end
`;
}
...
async function showLovePreview(code, editor = null, editorLog = null, options = {}) {
  ...
  backdrop.innerHTML = `
    <div class="modal love-preview-modal">
      ...
      <div class="love-calculator-editor">
        ...
        <div id="love-calculator-template-panel" class="love-calculator-template-panel love-calculator-template-love-panel" hidden>
          <canvas id="love-calculator-template-canvas" class="love-calculator-template-canvas" width="700" height="560" tabindex="0" aria-label="${escapeHtml(t("calculatorTemplates"))}"></canvas>
        </div>
      </div>` : ""}
  ...
  if (calculatorEditor) {
    ...
    const paletteCanvas=backdrop.querySelector("#love-calculator-template-canvas");
    let paletteRuntime=null;
    const ensurePaletteLove=async()=>{
      if(paletteRuntime || !paletteCanvas)return;
      const paletteCtx=paletteCanvas.getContext("2d");
      const silentLog=document.createElement("pre");
      paletteRuntime=await createLovePreviewRuntime(calculatorLoveTemplatePaletteLua(),paletteCtx,paletteCanvas,silentLog,{});
      paletteRuntime.boot();
      calculatorEditor.paletteRuntime=paletteRuntime;
    };
    toggle?.addEventListener("click",async()=>{
      panel.hidden=!panel.hidden;
      if(!panel.hidden){await ensurePaletteLove();paletteCanvas?.focus();}
      else capture?.focus();
    });
    paletteCanvas?.addEventListener("click",(event)=>{
      ...
      const cols=5,rows=5,mx=8,my=8,gap=6,top=25;
      const cw=(paletteCanvas.width-mx*2-gap*(cols-1))/cols;
      const ch=(paletteCanvas.height-top-my-gap*(rows-1))/rows;
      const col=Math.floor((px-mx)/(cw+gap));
      const row=Math.floor((py-top)/(ch+gap));
      if(col<0||col>=cols||row<0||row>=rows)return;
      const cellX=mx+col*(cw+gap),cellY=top+row*(ch+gap);
      if(px<cellX||px>cellX+cw||py<cellY||py>cellY+ch)return;
      const index=row*cols+col;
      const entry=TI_CALCULATOR_TEMPLATES[index];
      if(!entry)return;
      calculatorLoveInsertTemplate(calculatorEditor.mathState,entry[0]);
      panel.hidden=true;
      calculatorEditor.refreshLove();
      capture?.focus();
    });
  ...
  const closeLovePreview = () => {
    ...
    calculatorEditor?.paletteRuntime?.close?.();
    closeModal(backdrop, () => runtime?.close());
  };

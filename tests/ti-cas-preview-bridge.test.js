...
const source = fs.readFileSync(new URL("../ti-cas-preview-bridge.js", import.meta.url), "utf8");
let captured = null;
const windowObject = {
...
vm.runInContext(source, context, { filename: "ti-cas-preview-bridge.js" });
...
console.log("ti-cas-preview-bridge tests: OK");
